...
public:
     ...
     */
    inline int isMessageEnabled(uint msg_type) { return mMessageEnabler & msg_type; }
     ...
     */
    inline bool isVideoRecordingEnabled() const { return mVideoRecEnabled; }
