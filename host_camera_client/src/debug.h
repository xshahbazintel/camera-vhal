...
#define VERBOSE_TAG_LIST                                                       \
    ...
    _VERBOSE_TAG(modem, "virtual GSM modem")                                  \
    _VERBOSE_TAG(radio, "virtual GSM AT Command channel")                     \
    ...
    _VERBOSE_TAG(remote, "remote multiplexer daemon")                            \
    _VERBOSE_TAG(gps, "virtual GPS")                                          \
    _VERBOSE_TAG(nand_limits, "nand/flash read/write thresholding")            \
    _VERBOSE_TAG(hw_control, "virtual power/flashlight/led/vibrator")         \
    _VERBOSE_TAG(avd_config, "android virtual device configuration")           \
    _VERBOSE_TAG(sensors, "virtual sensors")                                  \
    ...
    _VERBOSE_TAG(adbclient, "ADB REMOTE client")                                 \
